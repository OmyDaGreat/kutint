...
class WebTest {
    ...
    fun `test HSL to RGB conversion`() {
        val hsl = hsl(0f, 100f, 50f) // Pure red
        val rgb = hsl.toRGB()
    ...
    fun `test blend mixes colors`() {
        val color1 = rgb(100, 100, 100)
        val color2 = rgb(200, 200, 200)
